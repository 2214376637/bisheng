...
async def run_tests():
    ...
    with get_sync_db_session() as session:
        ...
        kb_main = Knowledge(id=99994, name="教务处通知库", user_id=1, level=0)
        kb_org_a = Knowledge(id=99995, name="普通学院节点", user_id=1, parent_id=99994, level=1)
        kb_org_b = Knowledge(id=99996, name="人事处节点", user_id=1, parent_id=99994, level=1)
        session.add(kb_main)
